...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/constants-path-sep-win32/tags). For example,

```javascript
PATH_SEP_WIN32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path-sep-win32@v0.2.0-umd/browser.js' )
```
